<?php
function insertDataAndGetResponse($data) {
    ...
    if ($result->num_rows > 0) {
        ...
        return json_encode($row); // Send back the inserted row as JSON
    } else {
        return json_encode(["error" => "No data found"]); // In case of no data found
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    echo insertDataAndGetResponse($json);
}
?>
